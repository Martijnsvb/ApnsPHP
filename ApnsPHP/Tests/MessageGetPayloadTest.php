...
class MessageGetPayloadTest extends MessageTest
{
    ...
    {
        $this->class->setText($this->getLargeText());
    ...
    {
        $this->class->setTitle($this->getLargeText());
        $this->class->setText($this->getLargeText());
    ...
    /**
     * Return a text that is exactly 2090 bytes in size
     *
     * @return string 2090 bytes text
     */
    private function getLargeText()
    {
        $text = 'J+ctP9mKD0V+hAx4/V+FRW/uBYT5L/h2XwlNH2ja9Ox2evW7gwSy/zfyOWy1RX6Kak9Rnq+q/V0B6QmkRDd/lpGx8EKwy
